...
urlpatterns = [
    ...
    path('teacher/upload_course_resource/<int:course_id>/', views.upload_course_resource, name='upload_course_resource'),
    path('teacher/course/<int:course_id>/manage/', views.manage_course, name='manage_course'),
